...
var isBuffer = __webpack_require__(635);
...
const reduce = __webpack_require__(85);
var LoadingStatus;
...
(function (VENDORS) {
    VENDORS["Z"] = "z";
})(VENDORS = exports.VENDORS || (exports.VENDORS = {}));
var STEPS;
(function (STEPS) {
    STEPS[STEPS["VENDOR_SELECT"] = 0] = "VENDOR_SELECT";
    STEPS[STEPS["LOGIN"] = 1] = "LOGIN";
    STEPS[STEPS["FETCH"] = 2] = "FETCH";
    STEPS[STEPS["DOWNLOAD"] = 3] = "DOWNLOAD";
...
var DATA_TYPES;
(function (DATA_TYPES) {
    DATA_TYPES["ARTICLES"] = "articles";
    DATA_TYPES["CATEGORIES"] = "categories";
    DATA_TYPES["SECTIONS"] = "sections";
    // USERS = 'users', // enable if we need users
    DATA_TYPES["TICKETS"] = "tickets";
})(DATA_TYPES = exports.DATA_TYPES || (exports.DATA_TYPES = {}));
exports.DATA_TYPES_TO_LOAD = [
...
exports.PAGE_PER_CALL = 0;
exports.VERSION = '1.0.0';
exports.DOWNLOAD_FILE_NAME = 'backup';
...
Object.defineProperty(exports, "__esModule", { value: true });
function setVendorData(vendor, data) {
    return setStorage({ [vendor]: data });
}
exports.setVendorData = setVendorData;
...
function listenToStorageChanges(callback) {
    chrome.storage.onChanged.addListener(callback);
}
exports.listenToStorageChanges = listenToStorageChanges;
...
(function (MessageNames) {
    MessageNames["POPUP_CLOSE"] = "POPUP_CLOSE";
    MessageNames["START_OVER"] = "START_OVER";
    MessageNames["VENDOR_SELECT"] = "VENDOR_SELECT";
    MessageNames["DOWNLOAD"] = "DOWNLOAD";
    MessageNames["POPUP_OPEN"] = "POPUP_OPEN";
    MessageNames["AUTHENTICATE"] = "AUTHENTICATE";
    MessageNames["FETCH_DATA"] = "FETCH_DATA";
})(MessageNames || (MessageNames = {}));
window.onPopupClose = window.onPopupClose || {};
class Messages {
    static selectVendor(params) {
        return Messages.sendMessage(MessageNames.VENDOR_SELECT, params);
    }
    static requestAuthentication(params) {
        return Messages.sendMessage(MessageNames.AUTHENTICATE, params);
    }
    static requestDataFetch() {
        return Messages.sendMessage(MessageNames.FETCH_DATA);
    }
    static sendDataSaved() {
        return Messages.sendMessage(MessageNames.DOWNLOAD);
    }
    static sendStartOver() {
        return Messages.sendMessage(MessageNames.START_OVER);
    }
    static onVendorSelect(callback) {
        Messages.listenTo(MessageNames.VENDOR_SELECT, callback);
    }
    static onAuthenticationRequest(callback) {
        Messages.listenTo(MessageNames.AUTHENTICATE, callback);
    }
    static onFetchRequest(callback) {
        Messages.listenTo(MessageNames.FETCH_DATA, callback);
    }
    static onSendDataSaved(callback) {
        Messages.listenTo(MessageNames.DOWNLOAD, callback);
    }
    static onSendStartOver(callback) {
    ...
    static sendMessage(messageName, payload) {
        return new Promise((resolve, reject) => {
    ...
    static sendSyncMessage(messageName, payload) {
...
var normalizeHeaderName = __webpack_require__(637);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_isPlainObject__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(622);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseGetTag_js__ = __webpack_require__(614);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getPrototype_js__ = __webpack_require__(619);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__isObjectLike_js__ = __webpack_require__(621);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__root_js__ = __webpack_require__(615);
...
var actions;
(function (actions) {
    actions["POPUP_CLOSE"] = "POPUP_CLOSE";
    actions["ON_PROGRESS"] = "ON_PROGRESS";
    actions["INIT_VENDOR_DATA"] = "INIT_VENDOR_DATA";
    actions["INIT_SESSION"] = "INIT_SESSION";
    actions["SELECT_VENDOR"] = "SELECT_VENDOR";
    actions["FETCH"] = "FETCH";
    actions["FETCH_SUCCESS"] = "FETCH_SUCCESS";
    actions["AUTHENTICATE"] = "AUTHENTICATE";
    actions["AUTHENTICATE_SUCCESS"] = "AUTHENTICATE_SUCCESS";
    actions["POPUP_OPEN"] = "POPUP_OPEN";
    actions["INIT"] = "INIT";
    actions["ERROR"] = "ERROR";
...
var arrayEach = __webpack_require__(629),
    baseEach = __webpack_require__(86),
    castFunction = __webpack_require__(630),
    isArray = __webpack_require__(11);
...
var utils = __webpack_require__(18);
var settle = __webpack_require__(638);
...
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(643);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(644);
...
var enhanceError = __webpack_require__(639);
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(613);
const reducer_1 = __webpack_require__(628);
const middleware_1 = __webpack_require__(631);
const store = redux_1.createStore(reducer_1.reducer, redux_1.applyMiddleware(middleware_1.middleware));
middleware_1.dispatchInit(store);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(625);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bindActionCreators__ = __webpack_require__(626);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__applyMiddleware__ = __webpack_require__(627);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__compose__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_warning__ = __webpack_require__(264);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Symbol_js__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getRawTag_js__ = __webpack_require__(617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objectToString_js__ = __webpack_require__(618);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__freeGlobal_js__ = __webpack_require__(616);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__overArg_js__ = __webpack_require__(620);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(624);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(17), __webpack_require__(623)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_es_isPlainObject__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_warning__ = __webpack_require__(264);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__compose__ = __webpack_require__(265);
...
const actions_1 = __webpack_require__(266);
const LocalStorage_1 = __webpack_require__(95);
const forEach = __webpack_require__(267);
const INITIAL_STATE = {
    session: {
        step: constants_1.STEPS.VENDOR_SELECT,
        vendor: '',
        credentials: {},
        isFetching: false
    },
...
const handlers = {
    [actions_1.actions.INIT_SESSION]: (state, payload) => {
        const { session, error } = payload;
        return assignState(state, { session, error });
    },
    [actions_1.actions.INIT_VENDOR_DATA]: (state, payload) => {
        const { vendor, data } = payload;
        return assignState(state, { [vendor]: data, error: null });
    },
    [actions_1.actions.SELECT_VENDOR]: (state, payload) => {
        const { vendor } = payload;
        return assignState(state, { session: { vendor, step: constants_1.STEPS.LOGIN } });
    },
    [actions_1.actions.AUTHENTICATE]: (state) => {
        return assignState(state, { session: { isFetching: true }, error: null });
    },
    [actions_1.actions.AUTHENTICATE_SUCCESS]: (state, payload) => {
        const { credentials, countData } = payload;
        return assignState(state, { session: { isFetching: false, step: constants_1.STEPS.FETCH, credentials }, [state.session.vendor]: countData, error: null });
    },
    [actions_1.actions.ON_PROGRESS]: (state, payload) => {
        return assignState(state, { [state.session.vendor]: payload.data, error: null });
    },
    [actions_1.actions.FETCH]: (state) => {
        return assignState(state, { session: { step: constants_1.STEPS.DOWNLOAD, isFetching: true }, error: null });
    },
    [actions_1.actions.FETCH_SUCCESS]: (state, payload) => {
        return assignState(state, { [state.session.vendor]: payload.data, error: null, session: { isFetching: false } });
    },
    [actions_1.actions.INIT]: () => {
        return assignState(INITIAL_STATE, { session: { step: constants_1.STEPS.LOGIN, vendor: constants_1.VENDORS.Z } });
    },
    [actions_1.actions.ERROR]: (state, payload) => {
        const { error } = payload;
...
function reducer(state = INITIAL_STATE, action) {
    ...
    if (handler) {
        ...
        if (newState.session !== state.session) {
            LocalStorage_1.setSession(newState.session);
        }
        if (newState.error !== state.error) {
            LocalStorage_1.setError(newState.error);
        }
        if (newState.Z !== state.Z) {
            LocalStorage_1.setVendorData(constants_1.VENDORS.Z, newState.Z);
        }
    }
    return newState;
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const actions_1 = __webpack_require__(266);
const Messages_1 = __webpack_require__(201);
const constants_1 = __webpack_require__(36);
const ZAdaptor_1 = __webpack_require__(632);
const LocalStorage_1 = __webpack_require__(95);
const reduce = __webpack_require__(85);
let apiAdaptor = null;
function init(store) {
    Messages_1.default.onPopupOpen(() => {
        store.dispatch({ type: actions_1.actions.POPUP_OPEN });
    });
    Messages_1.default.onAuthenticationRequest((params, sendResponse) => {
        store.dispatch({ type: actions_1.actions.AUTHENTICATE, payload: { params, sendResponse } });
    });
    Messages_1.default.onFetchRequest((params, sendResponse) => {
        store.dispatch({ type: actions_1.actions.FETCH, payload: { params, sendResponse } });
    });
    Messages_1.default.onSendDataSaved((params, sendResponse) => {
        setTimeout(() => dispatchInit(store), 1500);
        sendResponseSafely({ received: true }, sendResponse);
    });
    Messages_1.default.onPopupClose(() => {
        store.dispatch({ type: actions_1.actions.POPUP_CLOSE });
    });
    Messages_1.default.onSendStartOver((params, sendResponse) => {
        sendResponseSafely({ received: true }, sendResponse);
        apiAdaptor.stop();
        setIdleBadge();
        dispatchInit(store);
    });
    Messages_1.default.onVendorSelect((params, sendResponse) => {
        store.dispatch({ type: actions_1.actions.SELECT_VENDOR, payload: { vendor: params.vendor } });
        sendResponseSafely({ received: true }, sendResponse);
    });
    LocalStorage_1.listenToStorageChanges((changes) => {
    ...
    Promise.all([
        LocalStorage_1.getSession(),
        LocalStorage_1.getError()
    ]).then(([session, error]) => {
        store.dispatch({ type: actions_1.actions.INIT_SESSION, payload: { session, error } });
    });
}
function onVendorSelect(store, payload) {
    const { vendor } = payload;
    switch (vendor) {
        case constants_1.VENDORS.Z:
            apiAdaptor = new ZAdaptor_1.default();
            break;
    }
    LocalStorage_1.getVendorData(vendor)
        .then(data => {
        store.dispatch({ type: actions_1.actions.INIT_VENDOR_DATA, payload: { vendor, data } });
    });
}
...
function onAuthenticateRequest(store, payload) {
    ...
    apiAdaptor.authenticate(params)
        ...
        store.dispatch({ type: actions_1.actions.AUTHENTICATE_SUCCESS, payload: { credentials: params, countData } });
    })
        .catch(error => {
...
function onFetchRequest(store, payload) {
    apiAdaptor.onProgress(data => {
        store.dispatch({ type: actions_1.actions.ON_PROGRESS, payload: { data } });
    });
    const { sendResponse, params = { dataTypes: constants_1.DATA_TYPES_TO_LOAD } } = payload;
    ...
    apiAdaptor.getData({ cachedData, dataTypes })
        .then((data) => {
        store.dispatch({ type: actions_1.actions.FETCH_SUCCESS, payload: { data } });
        setIdleBadge();
        if (isPopupOpen()) {
...
function setSuccessBadge() {
    chrome.browserAction.setIcon(constants_1.LOGOS.SUCCESS);
}
function setIdleBadge() {
    chrome.browserAction.setIcon(constants_1.LOGOS.IDLE);
}
function setFetchBadge() {
    chrome.browserAction.setIcon(constants_1.LOGOS.FETCH);
}
function setErrorBadge() {
    chrome.browserAction.setIcon(constants_1.LOGOS.ERROR);
}
function stayAwake() {
...
function saveError(store, error) {
    store.dispatch({ type: actions_1.actions.ERROR, payload: { error } });
}
...
function dispatchInit(store) {
    store.dispatch({ type: actions_1.actions.INIT });
    //TODO remove this after adding vendor select
    store.dispatch({ type: actions_1.actions.SELECT_VENDOR, payload: { vendor: constants_1.VENDORS.Z } });
}
exports.dispatchInit = dispatchInit;
const handlers = {
    [actions_1.actions.INIT]: init,
    [actions_1.actions.SELECT_VENDOR]: onVendorSelect,
    [actions_1.actions.POPUP_OPEN]: onPopupOpen,
    [actions_1.actions.POPUP_CLOSE]: onPopupClose,
    [actions_1.actions.AUTHENTICATE]: onAuthenticateRequest,
    [actions_1.actions.FETCH]: onFetchRequest,
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const axios_1 = __webpack_require__(633);
const constants_1 = __webpack_require__(36);
const forEach = __webpack_require__(267);
const get = __webpack_require__(72);
const isEmpty = __webpack_require__(652);
const values = __webpack_require__(653);
const noop = __webpack_require__(655);
var RESPONSE_ERRORS;
(function (RESPONSE_ERRORS) {
    RESPONSE_ERRORS[RESPONSE_ERRORS["MERGE_CONFLICT"] = 409] = "MERGE_CONFLICT";
    RESPONSE_ERRORS[RESPONSE_ERRORS["UNPROCESSABLE_ENTITY"] = 422] = "UNPROCESSABLE_ENTITY";
    RESPONSE_ERRORS[RESPONSE_ERRORS["RATE_LIMIT_ERROR"] = 429] = "RATE_LIMIT_ERROR";
    RESPONSE_ERRORS[RESPONSE_ERRORS["DATABASE_TIMEOUT"] = 503] = "DATABASE_TIMEOUT";
...
class ZAdaptor {
    ...
    authenticate(params) {
        ...
        return this.getData({ dataTypes: values(constants_1.DATA_TYPES), limit: 1 })
            .then((data) => {
            this.data = data;
            return data;
        });
    ...
    fetchData(type, limit) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            while (apiUrl && count < limit) {
                try {
                    apiUrl = yield this.fetchPageAndUpdate(type, apiUrl);
                    count++;
                    errorCount = 0;
                }
                catch (error) {
    ...
    fetchPageAndUpdate(type, apiUrl) {
        return new Promise((resolve, reject) => {
            this.get(apiUrl)
                .then((page) => {
...
axios.Cancel = __webpack_require__(272);
axios.CancelToken = __webpack_require__(650);
axios.isCancel = __webpack_require__(271);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __webpack_require__(651);
...
var defaults = __webpack_require__(202);
var utils = __webpack_require__(18);
var InterceptorManager = __webpack_require__(645);
var dispatchRequest = __webpack_require__(646);
...
var utils = __webpack_require__(18);
var transformData = __webpack_require__(647);
var isCancel = __webpack_require__(271);
var defaults = __webpack_require__(202);
var isAbsoluteURL = __webpack_require__(648);
var combineURLs = __webpack_require__(649);
...
var Cancel = __webpack_require__(272);
...
var baseValues = __webpack_require__(654),
    keys = __webpack_require__(37);
